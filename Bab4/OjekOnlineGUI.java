...
public class OjekOnlineGUI extends javax.swing.JFrame {
    ...
    String pembayaran = txtPembayaran.getText().trim();

    // Validasi input
    if (nama.isEmpty() || hp.isEmpty() || tujuan.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Mohon lengkapi data pelanggan!", "Peringatan", JOptionPane.WARNING_MESSAGE);
        return;
    }

    // Buat objek Pelanggan dan Driver
    Pelanggan pelanggan = new Pelanggan(nama, hp, tujuan);
    Driver driver = new Driver("Budi", "Honda Vario 125");

    // Tampilkan hasil pemesanan di memo
    StringBuilder hasil = new StringBuilder();
    hasil.append("=== PEMESANAN OJEK BERHASIL ===\n");
    hasil.append("Nama Pelanggan   : ").append(pelanggan.getNama()).append("\n");
    hasil.append("Nomor HP         : ").append(pelanggan.getNoHP()).append("\n");
    hasil.append("Tujuan           : ").append(pelanggan.getTujuan()).append("\n");
    hasil.append("Pembayaran       : ").append(pembayaran.isEmpty() ? "Bayar di Tempat" : pembayaran).append("\n");
    hasil.append("----------------------------------\n");
    hasil.append("Driver           : ").append(driver.getNamaDriver()).append("\n");
    hasil.append("Kendaraan        : ").append(driver.getMotor()).append("\n");
    hasil.append("Status           : ").append(driver.getStatus());

    memo1.setText(hasil.toString());
